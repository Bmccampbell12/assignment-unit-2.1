...
let introduction = "My name is" + " " + "Bruce McCampbell" + "," + " " + "and i think" + " " + "33" + " " + "is a winner!";
...
if (result == "How about we stay home?"){
console.log( 'result' );
}
if(result = "How about we stay home?"){
...
if( luckyNumber == 2 && Boolean|adventurous){
